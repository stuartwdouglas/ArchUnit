...
public class ClassFileImporterAutomaticResolutionTest {
    ...
    public void automatically_resolves_class_annotations() {
        ...
        assertThat(annotation.getRawType().isFullyImported()).as("annotation type is fully imported").isTrue();
    ...
    public void automatically_resolves_field_access_target_owners() {
        ...
        assertThat(access.getTargetOwner().isFullyImported()).isTrue();
    }
    ...
    public void automatically_resolves_method_call_target_owners() {
        ...
        assertThat(call.getTargetOwner().isFullyImported()).isTrue();
    }
    ...
    public void automatically_resolves_method_reference_target_owners() {
        ...
        assertThat(reference.getTargetOwner().isFullyImported()).isTrue();
    }
    ...
    public void test_automatically_resolves_annotation_parameter_types(JavaClass annotationValue, Class<?> expectedType) {
        assertThat(annotationValue.isFullyImported()).as("annotation value type has been fully imported").isTrue();
    ...
    public void automatically_resolves_types_of_throws_declarations() {
        ...
        assertThat(throwsDeclaration.getRawType().isFullyImported()).as("type of throws declaration has been fully imported").isTrue();
    ...
    public void automatically_resolves_array_component_types() {
        ...
        assertThat(componentType.isFullyImported())
                .as("array component type of %s has been fully imported", javaClass.getMethod("oneDim").getRawReturnType().getName())
                .isTrue();
